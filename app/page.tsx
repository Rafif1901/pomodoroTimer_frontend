            ...
            <div className="max-w-xl mx-auto px-4 py-8 mt-4">
                <div className="bg-white/10 rounded-lg p-6 sm:p-8 text-center shadow-lg">
                    ...
                    <div className="flex justify-center items-center gap-4">
                        ...
                        {isActive && (
                            <button onClick={() => setTimeLeft(0)} className="bg-white text-black hover:text-gray-200 transition">
                                <svg className="w-7 h-7 ml-1" fill="currentColor" viewBox="0 0 20 20"><path d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" /></svg>
                            </button>
                        )}
                    </div>
                </div>
